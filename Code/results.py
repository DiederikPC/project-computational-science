...
for i in parameter_range:
    SI_FB = get_metrics(True, False, i, i_init, time_steps, decay_rate, sims, threshold)
    SI_BA = get_metrics(True, True, i, i_init, time_steps, decay_rate, sims, threshold)
...
def average_error_percent(FB, BA):
    """
    Returns the average percentage difference between Facebook and Barabasi-Albert values
    Arguments are a list for a metric for FB and a list for the same metric for BA
    """
